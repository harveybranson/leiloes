# -*- coding: utf-8 -*-
"""
Scraper de imoveis dos leiloeiros REGULARES do Acre (JUCEAC) - PDF "Leiloeiros Acre".
Entrada : csv/leiloeiros_acre_2026-06-09.csv
...
Report  : por leiloeiro a cada 5 min (scraper_acre_progress.json + stdout).
"""
...
CSV_IN = BASE / "csv" / "leiloeiros_acre_2026-06-09.csv"
OUT_DIR = BASE / "csv"
DB = BASE / "imoveis_leiloeiros.db"
PROG = BASE / "scraper_acre_progress.json"
JUNTA = "JUCEAC/AC"
...
def main():
    ...
    print("=" * 72)
    print(f"SCRAPER ACRE/JUCEAC | captura {CAPTURE:%d/%m/%Y %H:%M} | {len(leiloeiros)} leiloeiros")
    print("=" * 72, flush=True)
    ...
    if all_im:
        out = OUT_DIR / f"imoveis_acre_{CAPTURE:%Y-%m-%d}.csv"
