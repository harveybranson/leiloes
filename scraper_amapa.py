# -*- coding: utf-8 -*-
"""
Scraper de imoveis dos leiloeiros REGULARES do Amapa (JUCAP) - PDF "Leiloeiros Amapa".
Entrada : csv/leiloeiros_amapa_2026-06-09.csv
...
Report  : por leiloeiro a cada 5 min (scraper_amapa_progress.json + stdout).
"""
...
CSV_IN = BASE / "csv" / "leiloeiros_amapa_2026-06-09.csv"
OUT_DIR = BASE / "csv"
DB = BASE / "imoveis_leiloeiros.db"
PROG = BASE / "scraper_amapa_progress.json"
JUNTA = "JUCAP/AP"
...
def main():
    ...
    print("=" * 72)
    print(f"SCRAPER AMAPA/JUCAP | captura {CAPTURE:%d/%m/%Y %H:%M} | {len(leiloeiros)} leiloeiros")
    print("=" * 72, flush=True)
    ...
    if all_im:
        out = OUT_DIR / f"imoveis_amapa_{CAPTURE:%Y-%m-%d}.csv"
