# -*- coding: utf-8 -*-
"""
Scraper de imoveis dos leiloeiros REGULARES do Para (JUCEPA) - PDF "Leiloeiros Para".
Entrada : csv/leiloeiros_para_2026-06-09.csv (53 regulares; exclui IRREGULAR/CANCELADA)
...
Report  : por leiloeiro a cada 5 min (scraper_para_progress.json + stdout).
"""
...
CSV_IN = BASE / "csv" / "leiloeiros_para_2026-06-09.csv"
OUT_DIR = BASE / "csv"
DB = BASE / "imoveis_leiloeiros.db"
PROG = BASE / "scraper_para_progress.json"
JUNTA = "JUCEPA/PA"
...
def main():
    ...
    print("=" * 72)
    print(f"SCRAPER PARA/JUCEPA | captura {CAPTURE:%d/%m/%Y %H:%M} | {len(leiloeiros)} leiloeiros")
    print("=" * 72, flush=True)
    ...
    if all_im:
        out = OUT_DIR / f"imoveis_para_{CAPTURE:%Y-%m-%d}.csv"
